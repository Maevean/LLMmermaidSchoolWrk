...
def main():
    ...
    root = tk.Tk()
    #Setting GUI title
    root.title("SeaDust -v" +str(version) + " - " + todays_date)

    #Assign image as var
    image_path = "Sea.png"
    image_path2 = "Bottom.png"
    ...
    my_dark_blue = "#30595D"
    my_yellow = "#69D4CE"
    text_area_display.config(background=my_dark_blue, foreground=my_purple, font= ("Papyrus", 11))
    ...
    #let users know what LLM they're using
    model_path_label = tk.Label(frame_controls, text="Model Path: " + model_path, foreground=my_dark_blue, font=("Mistral", 12))
    ...
    text_area_main_user_input.config(background=my_dark_blue, foreground=my_yellow, font=("Harrington", 12))
    ...
    #Button to send usr input, enter key will not work (unless designed to)
    send_button = tk.Button(root, text="Send", command=send_message, background=my_dark_blue, foreground="white", font=("Harrington", 17))
    send_button.pack()
